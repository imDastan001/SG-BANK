...
<head>
  ...
  <title>SG Bank Transfer money page</title>
  ...
  <div class=information>
    <div class=hello>
      ...
      <div class=info>
        <p>Hello,
        <p>
        <p><b><%out.print(session.getAttribute("name"));%></b></p>
      </div>
    </div>
    <div class=form>
      <form action="transferamnt.jsp">
        <div class="form-outline mb-4">
            <input type="number" id="form3Example3" name="acount_number" class="form-control" />
        ...
        <button id="button" type="submit">Transfer</a>
